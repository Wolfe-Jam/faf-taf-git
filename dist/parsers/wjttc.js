...
exports.parseWjttcOutput = parseWjttcOutput;
        ...
        try {
            ...
            if (Array.isArray(body.results) && body.results.length > 0) {
                ...
                if (t !== fromRows && fromRows > 0) {
                    ...
                    t = fromRows;
                    p = body.results.filter((r) => r && r.ok === true).length;
                    f = t - p;
                }
            }
            return {
 ...
 */
function parseWjttcOutput(output) {
